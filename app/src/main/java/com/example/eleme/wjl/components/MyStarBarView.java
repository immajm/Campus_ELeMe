 ...
 * @version : 1.0
 * @author: momoshenchi
 * @date: 2021/1/10 - 23:57
 */
public class MyStarBarView extends View
{
    ...
    public MyStarBarView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public MyStarBarView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        this.starMark=mTypedArray.getFloat(R.styleable.RatingBar_starRate,4.7f);
        mTypedArray.recycle();
